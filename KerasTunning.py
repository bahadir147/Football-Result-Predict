...
y_train = np_utils.to_categorical(ids, 10)
...
def create_model(optimizer='rmsprop', init='glorot_uniform'):
    model = Sequential()
    model.add(Dense(10, input_shape=(39,)))
...
init = ['uniform', 'lecun_uniform', 'normal', 'zero',
        'glorot_normal', 'glorot_uniform', 'he_normal', 'he_uniform']
epochs = np.array([10, 50, 100, 150, 200, 300])
batches = np.array([5, 10, 20, 100, 500, 1000, 5000])
